...
case_data = {}
for case in cases:
    filename = f"../{case}_deceleration.csv"
...
for case, data in case_data.items():
    ...
    if case=="AOAp180SDAp340SGPp094SOLn081":
        ...
        label = "Case 08"
    elif case=="AOAp130SDAp360SGPp040SOLn018":
        label = "Case 04"
    else:
        label = "Case"
    ...
    plt.ylabel('Streamwise Deceleration $\\frac{-VdV}{ds}/(m/s^2)$')
    plt.legend(loc='lower left')
    
    # Save the plot
    plt.savefig(f'{case}_dec.png')
    plt.close()
